...
\textbf{Alternate RF/ERT specifications:}
\begin{itemize}
    \item DEFAULT: mtry = p/3, base learners = 500, min-n = 3 (Nolte)
    \item ", ", min-n = 5 (ranger default)
    \item ", base learners = 250 (Nolte alternate), "
\end{itemize}
